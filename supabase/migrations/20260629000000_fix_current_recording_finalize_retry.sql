...
revoke execute on function public.discard_uploaded_couple_recording(uuid, text)
  from public, anon;

grant execute on function public.discard_uploaded_couple_recording(uuid, text)
  to authenticated;
