...
| 신고 운영 알림 | 신고 ID, 대상 종류, 사유 분류, 신고 시각, 상세 설명·스냅샷 존재 여부 | 새 신고의 운영 검토 요청과 중복 방지 | 출시 전 확정할 HTTPS 운영 수신기 |
...
3. 신고 기록과 발송·AI 진단 로그의 구체적인 보관 기간
4. 국외 이전 국가·리전, 이전 시점·방법, 보유 기간을 포함한 각 외부 처리자 계약 정보
5. 웹 계정 삭제 요청의 본인 확인 및 운영 처리 절차
6. 개인정보처리방침·이용약관 시행일
7. 신고 기록을 계정 삭제와 함께 제거할지, 익명화 후 별도 보관할지 여부
...
- 신고 모더레이션 알림 큐와 최소 메타데이터 전송 워커는 구현됐지만 실제
  HTTPS 수신 채널·담당자·검토 목표 시간은 아직 확정되지 않았다.
